...
const Dashboard = () => {
  ...
  const [isInventoryCheckModalVisible, setIsInventoryCheckModalVisible] =
    useState(false);
  ...
  const inventoryTabs = [
    ...
    },
    {
      key: "transactions",
      label: "Giao dịch",
      children: <InventoryTransactions />,
    },
                ...
                validator: (_, value) => {
                  if (!value)
                    return Promise.reject(
                      new Error("Vui lòng chọn ngày kiểm kê!")
                    );
                  if (
                    value &&
                    typeof value.isValid === "function" &&
            ...
            rules={[
              {
                ...
                validator: (_, value) => {
                  if (!value || !Array.isArray(value) || value.length !== 2) {
                    return Promise.reject(
                      new Error("Vui lòng chọn khoảng thời gian!")
                    );
                  }
